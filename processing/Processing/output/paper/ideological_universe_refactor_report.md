...
Primary cabinet gaps range from 7 to 16; all 23 closures and nearest-interval overlaps were recomputed using represented cabinet members. Observed cabinet membership and electoral accounting use their existing definitions.
