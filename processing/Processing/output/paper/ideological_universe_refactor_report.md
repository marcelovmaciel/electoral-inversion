...
Primary cabinet gaps range from 4 to 16; all 53 closures and nearest-interval overlaps were recomputed using represented cabinet members. Observed cabinet membership and electoral accounting use their existing definitions.
