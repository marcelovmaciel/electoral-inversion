\begin{table}[htbp]
\centering
\caption{Exact connectedness and the one-gap relaxation: minimal winning parliamentary coalitions}
...
\(k\) is the maximum number of omitted represented parties inside a coalition's ideological span: \(k=0\) requires exact connectedness, and \(k=1\) also permits one omission.
