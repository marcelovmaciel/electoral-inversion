\begin{table}[htbp]
\centering
\caption{Minimal winning parliamentary coalitions by ideological domain}
...
\end{tabularx}
\begin{flushleft}
\footnotesize Notes: The ideological order contains Chamber-represented parties only.
\(k\) counts omitted represented parties inside a coalition's ideological span.
Minimality is defined within each stated domain. Vote shares use all valid votes, including votes for zero-seat parties.
