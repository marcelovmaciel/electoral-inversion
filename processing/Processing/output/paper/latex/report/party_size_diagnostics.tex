...
\par Among 35 cabinet party sets, 35 have positive \(A_C\); \(B_C>0\) in 13. There are 35 distinct election-year party sets. Positive contributions from members with at least 5\% of votes exceed all negative member contributions in 34 sets; they supply 48.23--100.00\% of gross positives. The smallest such remaining balance is -1.23 seats. Net \(A_C\) ranges from 3.34 to 21.41 seats.
\begin{itemize}
...
\item 2018 recurring positive members: PP: \(A_i=7.32\), 13 distinct sets; PR: \(A_i=6.37\), 6 distinct sets; DEM: \(A_i=4.58\), 14 distinct sets.
