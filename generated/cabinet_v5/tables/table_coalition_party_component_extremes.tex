...
2018/PT--PSDB & \mbox{PT} (4.88)\newline \mbox{MDB} (4.34) & \mbox{PV} (-4.01)\newline \mbox{REDE} (-3.94) & \mbox{SOLIDARIEDADE} (1.81)\newline \mbox{MDB} (1.26) & \mbox{PT} (-1.75)\newline \mbox{PSDB} (-1.18) \\
